  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="prose text-gray-600 space-y-4">
        ...
        <p>MANTO respects your privacy. This policy describes how we collect, use, and protect your personal information.</p>
        <h2 className="text-xl font-bold text-black pt-4">Information We Collect</h2>
        ...
        <h2 className="text-xl font-bold text-black pt-4">How We Use Your Information</h2>
        ...
        <h2 className="text-xl font-bold text-black pt-4">Data Security</h2>
