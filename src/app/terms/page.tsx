...
export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <h1 className="text-3xl font-bold text-manto-white mb-6">Terms of Service</h1>
      <div className="prose text-manto-gray space-y-4">
        <p>Last updated: {new Date().toLocaleDateString()}</p>
        <p>By using MANTO, you agree to these terms.</p>
        <h2 className="text-xl font-bold text-manto-white pt-4">Orders & Payment</h2>
        ...
        <h2 className="text-xl font-bold text-manto-white pt-4">Shipping</h2>
        <p>Delivery times are estimates. We are not responsible for carrier delays. Free shipping on orders over $50.</p>
        <h2 className="text-xl font-bold text-manto-white pt-4">Returns</h2>
        ...
        <h2 className="text-xl font-bold text-manto-white pt-4">Limitation of Liability</h2>
