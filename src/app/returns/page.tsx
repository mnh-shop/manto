...
export default function ReturnsPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <h1 className="text-3xl font-bold text-manto-white mb-6">Returns & Refunds</h1>
      <div className="prose text-manto-gray space-y-4">
        ...
        <h2 className="text-xl font-bold text-manto-white pt-4">30-Day Money-Back Guarantee</h2>
        <p>Return any product within 30 days of delivery for a full refund. Items must be in original condition.</p>
        <h2 className="text-xl font-bold text-manto-white pt-4">How to Return</h2>
        ...
        <h2 className="text-xl font-bold text-manto-white pt-4">Defective Products</h2>
